...
转载自[ceven2010](http://blog.csdn.net/ceven2010/article/details/7406341)
...
**6、移动到段首{，移动到段尾}**  
7、**移动到下一个词w，移动到上一个词b，移动到当前单词的结尾e，移动到上一单词结尾ge，用空白字串分割的单词移动W、B、gE等等**  
**8、移动到文档开始gg，移动到文档结束G**  
9、移动到匹配的{}.().[]处%  
**10、跳到第n行 ngg 或 nG 或 :n**  
11、移动光标到屏幕顶端H，移动到屏幕中间M，移动到底部L  
12、读取当前字符，并移动到本屏幕内下一次出现的地方 _  
...
34、~ 将光标下的字母改变大小写  
35、3~ 将光标位置开始的3个字母改变其大小写  
36、g~~ 改变当前行字母的大小写  
37、U 将可视模式下选择的字母全改成大写字母  
38、u 将可视模式下选择的字母全改成小写  
39、gUU 将当前行的字母改成大写  
40、3gUU 将从光标开始到下面3行字母改成大写  
41、guu 将当前行的字母全改成小写  
42、gUw 将光标下的单词改成大写。  
43、guw 将光标下的单词改成小写。

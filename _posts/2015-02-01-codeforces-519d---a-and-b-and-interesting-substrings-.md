...
#  [Codeforces 519D - A and B and Interesting Substrings (思维)](/2015/02/codeforces-519d/ "Codeforces 519D - A and B and Interesting Substrings \(思维\)")

By [MyCodeBattle](http://mycodebattle.gitcafe.io/about "MyCodeBattle")

Published Feb 28 2015 23:27
...
遍历一遍字符。当查到到i这个位置时，判断`map[str[i]]`里是否有`sum[i-1]`，如果有的话就加上出现的次数。

然后更新一下`map[str[i]][sum[i-1]]`。

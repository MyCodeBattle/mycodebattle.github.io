...
#  [UVa 1451 - Average (斜率优化 + 单挑队列)](/2015/02/UVa-1451/ "UVa 1451 - Average \(斜率优化 + 单挑队列\)")

By [MyCodeBattle](http://mycodebattle.gitcafe.io/about "MyCodeBattle")

Published Feb 20 2015 22:59
...
一开始不小心把返回斜率的函数定义成`bool`，所以返回不出第三种状态了。被搞死TAT
...
[Online Judge - UVa](/tags/Online-Judge-UVa/)[Foundation - Slope Optimization](/tags/Foundation-Slope-Optimization/)
